 ...
 *
 * @returns {BitBufferArray} - A BitBufferArray object containing BitBuffer representations of each character in the
 *   string.
 */
 ...
 * @param {string} fillString - The string to use as padding. If this string is longer than one character, the first
 *   character will be used as the padding.
